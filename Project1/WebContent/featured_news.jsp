...
%>
	...
	%>
			...
			<%
				List<r_news> rNaverNewsList = replycount.getNaverReplyCount(dbname);
										for(int i=0;i<10;i++){
			...
			<%
				List<r_news> rDaumNewsList = replycount.getDaumReplyCount(dbname);
										for(int i=0;i<10;i++){
		...
		%>
				...
				<%
					List<l_news> lNaverNewsList = likebad.getNaverLikeBad(dbname);
									for(int i=0;i<10;i++){
			...
			%>
					...
					<%
						List<l_news> lDaumNewsList = likebad.getDaumLikeBad(dbname);
												for(int i=0;i<10;i++){
