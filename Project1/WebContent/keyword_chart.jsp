...
<div id="header-wrapper2">
		...
		<div id="three-column" class="container">
			...
			<%
				...
				String encodeName = URLEncoder.encode(dbname,"UTF-8"); // 인코딩해서 보내야함
				String url = "chart.jsp?dbname="+ encodeName;
			%>
		...
		function select_radio(){
			...
			location.href="featured_news.jsp?dbname="+dbname+"&select_rank="+select_rank;
		}
		</script>
