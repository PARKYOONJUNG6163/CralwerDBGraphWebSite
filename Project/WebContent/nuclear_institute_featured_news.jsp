<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="rank.getRankInstituteReplyCount"%>
<%@page import="rank.getRankInstituteLikeBad"%>
...
<%
	getRankInstituteReplyCount replycount = new getRankInstituteReplyCount();
...
<%
	getRankInstituteLikeBad likebad = new getRankInstituteLikeBad();
