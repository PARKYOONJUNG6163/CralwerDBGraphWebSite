<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="rank.getRankNuclearReplyCount"%>
<%@page import="rank.getRankNuclearLikeBad"%>
...
<%
	getRankNuclearReplyCount replycount = new getRankNuclearReplyCount();
...
<%
	getRankNuclearLikeBad likebad = new getRankNuclearLikeBad();
